...
from neural_mmo import entity, core
from neural_mmo.core.config import Config, SmallMaps
from neural_mmo.io import stimulus
from neural_mmo.io.stimulus.static import Stimulus
from neural_mmo.io.action import static as Action
from neural_mmo.systems import combat

from neural_mmo.lib import log

from neural_mmo.infra.overlay import OverlayRegistry
...
class Env(ParallelEnv):
   ...
   def __init__(self, config=None):
      ...
      if not config.AGENTS:
          from neural_mmo.infra import scripting
   ...
   def render(self, mode='human'):
      ...
      if not self.client:
         from neural_mmo.infra.twistedserver import Application
