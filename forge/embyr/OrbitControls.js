...
THREE.OrbitControls = function ( object, domElement ) {
	...
	this.update = function () {
		...
		return function update() {
            ...
            if ( state === STATE.KEYHELD ) {
               // implement smooth pan/rotate
            }
	...
	function handleKeyDown( event ) {
		...
		switch ( event.keyCode ) {
			...
			case scope.keys.W:
                handleKeyRotate( 0, scope.keyPanSpeed);
                state = STATE.ROTATE;
				break;

			case scope.keys.A:
                handleKeyRotate( scope.keyPanSpeed, 0);
                state = STATE.ROTATE;
				break;
	...
	function handleKeyRotate( pitch, yaw ) {

		rotateEnd.set( pitch, yaw );

		rotateDelta.copy( rotateEnd ).multiplyScalar(
                scope.rotateSpeed );
